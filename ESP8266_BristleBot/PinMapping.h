...
#define RIGHT 15      // Corresponds to GPI0_15 labelled pin D8 on NodeMCU board
#define LEFT 5        // Corresponds to GPIO_5 labelled pin D1 on NodeMCU board
...
#define IRTX 4        // Corresponds to GPIO4 labelled pin D2 on NodeMCU board
#define IRTXREAR 0    // Corresponds to GPIO0 labelled pin D3 on NodeMCU board
